...
const form = useForm({
    ...
    date_of_birth: props.patient.date_of_birth ? props.patient.date_of_birth.split('T')[0] : '',
    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center justify-between">
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">Editar Paciente: {{ patient.name }}</h2>
