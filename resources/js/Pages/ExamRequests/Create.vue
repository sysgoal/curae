    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center gap-4">
                <Link :href="route('patients.show', patient.id)" class="text-gray-400 hover:text-gray-600 transition-colors">
                ...
                <h2 class="font-bold text-xl text-gray-800">Solicitação de Exames: {{ patient.name }}</h2>
            </div>
        </template>
